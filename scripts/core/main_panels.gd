...
# Usage: var _main_panels = preload("res://scripts/core/main_panels.gd").new()
...
func build_parking() -> void:
	var parking_lot = preload("res://scripts/systems/parking_lot.gd").new()
...
func update_floor_hud() -> void:
	...
	var fd = preload("res://scripts/world/floor_config.gd").get_floor(_main._current_floor_idx)
