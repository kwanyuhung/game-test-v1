# staff_area_common_handler.gd
# ─────────────────────────────────────────────────────────────────────────────
# Handler for COMMON zones on Floor 6 (Staff Area)
# General walking/floor areas with staff area styling
# ─────────────────────────────────────────────────────────────────────────────
class_name StaffAreaCommonHandler

const CELL_SIZE := 16

static func build_staff_area_common(parent: Node, zone: Dictionary, floor_nodes: Array) -> void:
	...
	bg.color = Color(0.22, 0.23, 0.25)
	parent.add_child(bg)
	floor_nodes.append(bg)
	
	# Subtle floor pattern
	var tile_color := Color(0.20, 0.21, 0.23)
